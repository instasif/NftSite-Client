...
const TodayPicCard = ({ product }) => {
    ...
    return (
        <div className='mx-auto border shadow-lg rounded-xl w-60'>
            ...
            <button className='w-full bg-indigo-500 text-white rounded-b-xl text-xs font-bold p-3 flex justify-center items-center'><span className='mx-2 text-lg font-bold'><RiShoppingBagLine /></span>BUY NOW</button>
        </div>
    );
};
