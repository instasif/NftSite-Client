...
const ContantCard = ({ content }) => {
  ...
  return (
    <div className="relative card group card-compact  overflow-hidden  bg-base-100 shadow-l hover:shadow-2xl ">
      <figure class="relative max-w-xs overflow-hidden bg-cover bg-no-repeat">
        <img
          src={img}
...
/* <div class="relative h-48 w-64 bg-gray-200 rounded-lg overflow-hidden hover:shadow-lg">
  <img class="w-full h-full object-cover" src="https://via.placeholder.com/640x480.png" alt="Card Image">
  <button class="absolute bottom-0 left-0 w-full bg-blue-500 text-white py-2 hover:bg-blue-600">Button</button>
</div> */
